...
function SystemStatus() {
    ...
    useEffect(() => {
        ...
        let intervalId = 0;
        if (loading===true) {
            intervalId = setInterval(fetchBandwidthData, 30000);
        } else {
            intervalId = setInterval(fetchBandwidthData, 15000);
        }
    ...
    return (
        <div className="resource container">
            <h2>System Status</h2>
            <div>
                <h3 style={{marginBottom:"5px"}}>Real-time RAM Usage</h3>
            ...
            <div>
                <h3 style={{marginBottom:"5px"}}>Real-time Disk Usage</h3>
                <div className="disk">
            ...
            <div>
                <h3 style={{marginBottom:"5px"}}>Real-time Internet Bandwidth</h3>
                {loading ? (
